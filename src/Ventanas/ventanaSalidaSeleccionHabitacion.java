...
public class ventanaSalidaSeleccionHabitacion implements ActionListener {
 private ventanaPrincipal ventanaPrincipal;
    private ventanaSalidaBoleta ventanaSalidaBoleta;
    ...
    public ventanaSalidaSeleccionHabitacion(ventanaPrincipal C){
        initVentana();
	...
	continuar=new JButton("Continuar");
        seleccion_habitacion=new JLabel("Seleccione habitacion a desocupar");
    ...
    public void actionPerformed(ActionEvent e) {
       JButton source = (JButton)e.getSource();
        if(source.equals(cancelar)){
            ...
            if(ventanaSalidaBoleta==null){
                int v = ButtonPressed();
                ventanaPrincipal.setVisibleVentanaPrincipal(false);
                ventanaSalidaBoleta = new ventanaSalidaBoleta(ventanaPrincipal, habitacion[v]); 
            }
            else {
                int v = ButtonPressed();
                
                ventanaSalidaBoleta.textAreaSetText(habitacion[v]);
                ventanaSalidaBoleta.setVisible(true);
            }
